  ...
  return (
    ...
    <Container>
      ...
      <div className="mx-auto prose text-left dark:prose-invert mt-14">
         <p>
            Those in the Anglo-Orthodox tradition, or Anglo-Orthodoxy, share a spiritual history with the Anglo-Catholic tradition. The Anglo-Catholic tradition traces its roots back to the 18th Century Oxford Movement and the Tractarians who argued that Anglicanism was truly a part of the Catholic tradition of the Christian Church and carried the flame of Apostolic Succession. Anglo-Catholoism brought a return to elements of the liturgy that were lost in the BCP, prioritized weekly communion, returned altar candles, brought back incense, just to name a few contributions.
          </p>
          <p>
